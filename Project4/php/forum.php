...
?>
 ...
 <html lang="en">
	 <head>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat|Open+Sans|Poppins|Raleway">
	 </head>
 <body>
	 ...
	 <div class="content">
         ...
         <li>
			...
			<div class="sect sectOne">
					<h3 style="opacity: 0.7;">&lt;CODE/bug&gt;</h3>
			</div>
      ...
      <footer>
          ...
          <a class="item" href="create_category.php">Admin: Create a category</a>
      </footer>
	 </div>
